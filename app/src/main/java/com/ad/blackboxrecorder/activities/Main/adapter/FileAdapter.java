...
import com.ad.blackboxrecorder.activities.Main.model.playing.Decryptor;
import com.ad.blackboxrecorder.activities.Main.model.recording.Record;
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                ...
                                case R.id.action_option2:
                                    ...
                                    File pcm_file = null;
                                    try {
                                        pcm_file = new File(recordingsDirectory + "/temp");
                                    ...
                                    PCMDecoder.encodeToMp3(
                                            ...
                                            96000,                                        // Bit rate
                                            22000,                                        // Sample rate
                                            recordingsDirectory + "/temp.mp3" // Output MP3 file
                                    );
                                    File mp3_file = new File(recordingsDirectory + "/temp.mp3");
                                ...
                                case R.id.action_option3:
                                    ...
                                    File[] fileList = recordingsDirectory.listFiles();
